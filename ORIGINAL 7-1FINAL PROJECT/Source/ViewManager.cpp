...
//This allows for the scroll wheel to control speed of camera movement
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera panning up and down, this allows the camera to move up and down in the scene
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS)//this allows you to get an orthographic view of the scene
	{
		// change to a multi-view orthographic projection
		bOrthographicProjection = true;

		//camera settings to show a orthographic view
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_P) == GLFW_PRESS)//this allows you to get a perspective view of the scene
	{
